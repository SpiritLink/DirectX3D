...
void cRightArm::Setup()
{
	...
	for (size_t i = 0; i < m_vecVertex.size(); i += 6)
	{
		switch (i)
		{
		case 0:		cCubeNode::SetCubeTexturePixel(&m_vecVertex, i, 31, 20, 40, 31); break;
		case 6:		cCubeNode::SetCubeTexturePixel(&m_vecVertex, i, 31, 20, 40, 31); break;
		case 12:	cCubeNode::SetCubeTexturePixel(&m_vecVertex, i, 31, 20, 40, 31); break;
		case 18:	cCubeNode::SetCubeTexturePixel(&m_vecVertex, i, 31, 20, 40, 31); break;
